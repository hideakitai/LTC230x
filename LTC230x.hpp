...
enum Channel : uint8_t
{
    ...
    POSITIVE_2_NEGATIVE_COM = 0x90,
    POSITIVE_4_NEGATIVE_COM = 0xA0,
    POSITIVE_6_NEGATIVE_COM = 0xB0,
    POSITIVE_1_NEGATIVE_COM = 0xC0,
    POSITIVE_3_NEGATIVE_COM = 0xD0,
    POSITIVE_5_NEGATIVE_COM = 0xE0,
